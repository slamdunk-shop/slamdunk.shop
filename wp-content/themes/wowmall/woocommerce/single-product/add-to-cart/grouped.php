...
<form class=cart id=cart-form method=post enctype=multipart/form-data>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button class="single_add_to_cart_button btn btn-primary<?php if( isset( $wowmall_wc_lookbook ) && $wowmall_wc_lookbook ) { echo ' btn-sm'; } ?>"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
