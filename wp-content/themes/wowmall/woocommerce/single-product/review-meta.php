...
<?php } else { ?>
	...
	<p class="meta">
		<strong class="woocommerce-review__author"><?php echo get_comment_author_link( $comment ); ?> </strong>
		<?php
		...
		?>
		<span class="woocommerce-review__dash">&ndash;</span> <a
				href="<?php echo esc_url( get_comment_link( $comment ) ); ?>">
			<time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_attr( get_comment_date( wc_date_format() ) ); ?></time>
		</a>:
	</p>
