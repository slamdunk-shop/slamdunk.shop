...
<div class=checkout-login-wrapper>
	<?php echo '<div class=checkout-login><h3>' . apply_filters( 'woocommerce_checkout_login_message', __( 'Returning customer?', 'woocommerce' ) ) . '</h3><a href=# class=showlogin>' . __( 'Click here to login', 'woocommerce' ) . '</a></div>';
