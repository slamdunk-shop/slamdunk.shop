...
<div class=woocommerce-checkout-review-order-table>
	<h5><?php esc_html_e( 'Product', 'woocommerce' ); ?></h5>
	<?php
	...
	foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
		...
		if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
			...
			<div class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
				...
				<span class=amount><?php echo apply_filters( 'woocommerce_cart_item_subtotal', WC()->cart->get_product_subtotal( $_product, $cart_item['quantity'] ), $cart_item, $cart_item_key ); ?></span>
	...
	<table class="shop_table shop_table_responsive">
		<tbody>
			...
			<tr class=cart-subtotal>
				...
				<td data-title="<?php esc_html_e( 'Subtotal', 'wowmall' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
			</tr>
			...
			<tr class=order-total>
				...
				<td data-title="<?php esc_html_e( 'Total', 'wowmall' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
			</tr>
