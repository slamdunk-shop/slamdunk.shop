 ...
 * @extends  WC_Widget
 */
class Wowmall_Shortcodes_WC_Widget_Layered_Nav_Filters extends WC_Widget_Layered_Nav_Filters {
			...
			if ( ! empty( $_chosen_attributes ) ) {
				foreach ( $_chosen_attributes as $taxonomy => $data ) {
					foreach ( $data['terms'] as $term_slug ) {
						...
						if ( 'pa_brand' === $taxonomy && ! $term = get_term_by( 'slug', $term_slug, 'brand' ) ) {
							continue;
						}
						elseif ( 'pa_brand' !== $taxonomy && ! $term = get_term_by( 'slug', $term_slug, $taxonomy ) ) {
							continue;
						}
