		...
		if ( ! empty( $attribute_taxonomies ) ) {
			foreach ( $attribute_taxonomies as $attribute ) {
				if( 'color' === $attribute->attribute_type ) {
					add_action( 'pa_' . $attribute->attribute_name . '_add_form_fields', array( $this, 'add_product_attribute_color_field' ) );

					add_action( 'pa_' . $attribute->attribute_name . '_edit_form_fields', array( $this, 'edit_product_attribute_color_field' ) );
				}
			}
		}

		add_action( 'created_term', array( $this, 'save_attribute_color' ), 10, 3 );
		add_action( 'edit_term', array( $this, 'save_attribute_color' ), 10, 3 );
	}
